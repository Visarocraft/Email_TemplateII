...
function imageToDataUrl(imagePath) {
  try {
    ...
    if (imagePath.endsWith('.jpg') || imagePath.endsWith('.jpeg')) {
      mimeType = 'image/jpeg';
    } else if (imagePath.endsWith('.gif')) { //For the confetti
      mimeType = 'image/gif';
...
const celebrationDataUrl = imageToDataUrl("./email-templates/images/happy-astonished-african-american-woman-silver-fashionable-dress-winning-first-prize-gladly-celebrating.png");
